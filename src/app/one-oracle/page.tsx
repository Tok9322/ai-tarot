...
export default function OneOraclePage() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 py-4">
      <div className="text-center space-y-2">
        <h1 className="text-2xl font-bold text-amber-300">ワンオラクル</h1>
        <p className="text-purple-400/70 text-sm">
          1枚のカードがあなたへのメッセージを届けます
        </p>
      </div>
      ...
      {/* カードデッキ */}
      {!showReset && (
        <CardDeck spreadType="one-oracle" onComplete={handleComplete} />
      )}
